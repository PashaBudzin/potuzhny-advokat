...
export default function TemplateFillerRoute() {
    ...
    const onSubmit = useCallback(async () => {
        ...
        const templateBezV = await fetchTemplateArrayBuffer(templates["bezUchastiV"].templateUrl);

        const templateBezP = await fetchTemplateArrayBuffer(templates["bezUchastiP"].templateUrl);
