...
export function firstBetween(text: string, startSplit: string, endSplit: string): string | null {
...
export function removeTags(text: string | null) {
    if (!text) return text;
    return text.replace(/<[^>]*>/g, "");
}

export function normalizeAddress(text: string | null) {
    if (!text) return text;
